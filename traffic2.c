...
int fullRow(int *map, int, int *row, int *col);
int fullCol(int *map, int, int *row, int *col);
void moveRow(int *map, int, int *row, int *col);
void moveCol(int *map, int, int *row, int *col);
